...
def Jeu():
    ...
    def Niveau_2():
        obstacles_pregenere = [0, 1, 2, 3, 4, 5, 6, 7, 8, 86, 185, 184, 183, 122, 106, 108, 88, 68, 48, 26, 90,
                                      110, 49, 50, 51, 52, 53, 91, 92, 93, 95, 115, 135, 155, 175, 195, 215, 235, 255,
                                      172, 212, 152, 151, 150, 149, 148, 187, 189, 188, 169, 230, 231, 232, 229, 228,
                                      227, 54, 55, 56, 77, 57, 117, 97, 118, 156, 176, 196, 216, 236, 178, 173, 174,
                                      225, 224, 223, 243, 263, 283, 323, 324, 325, 326, 327, 328, 329, 309, 289, 269,
                                      249, 265, 285, 286, 287, 267, 297, 296, 295, 294, 293, 292, 252, 253, 291, 330,
                                      331, 332, 333, 334, 335, 336, 337, 264, 288]
        global liste_obstacles
        liste_obstacles = obstacles_pregenere
        for every in obstacles_pregenere:
            button_list[every].config(bg='#484848')
